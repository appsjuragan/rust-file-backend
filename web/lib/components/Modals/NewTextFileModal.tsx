...
const NewTextFileModal: React.FC<NewTextFileModalProps> = ({
    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit} className="rfm-new-folder-modal-form h-full flex flex-col pt-2">
                <div className="rfm-form-group mb-4">
                    <label className="text-xs font-bold text-stone-400 uppercase tracking-widest mb-1 block">File Name</label>
                    <input
                        autoFocus
                        type="text"
                ...
                <div className="rfm-form-group flex-1 flex flex-col min-h-0">
                    <label className="text-xs font-bold text-stone-400 uppercase tracking-widest mb-1 block">Content</label>
                    <textarea
