  ...
  return (
    <div className="rfm-swipe-item-container">
      ...
      >
        ...
        >
          <span
            className="flex items-center justify-center bg-stone-200 dark:bg-slate-700 p-1 rounded text-stone-600 dark:text-slate-300"
            title={share.permission === "download" ? "Download" : "View Only"}
          >
            <SvgIcon
              svgType={share.permission === "download" ? "download" : "eye"}
              size={10}
            />
          </span>
          <span
