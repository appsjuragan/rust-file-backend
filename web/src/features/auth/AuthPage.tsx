    ...
    >
      <div className="auth-card">
        ...
        <div className="rfm-app-title !items-center !gap-0 mb-4">
          <span className="rfm-app-title-main !text-4xl !tracking-tighter">
            Juragan
          </span>
          <span className="rfm-app-title-sub !text-4xl !tracking-tighter !-mt-4">
            Cloud
          </span>
        </div>
        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="auth-buttons">
            <button
              type="submit"
              className="login-btn"
              disabled={authLoading || captchaHook.isDisabled}
            >
