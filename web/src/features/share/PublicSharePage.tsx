...
const MediaViewer: React.FC<{ info: any; token: string; fileId?: string }> = ({
  ...
  return (
    <div
      className="rfm-share-media-container"
...
export const PublicSharePage: React.FC = () => {
  ...
  return (
    <div className="rfm-public-share-container">
      <div
        className="rfm-share-card animate-share-in"
        style={{
          maxWidth:
            (shareInfo?.is_folder ||
              isMediaSupported(
      ...
      >
        <div className="rfm-share-header">
          ...
          <h1 className="rfm-share-title">
            {shareInfo?.filename || "Shared Item"}
          </h1>
          ...
          {shareInfo?.requires_password && !isAuthorized ? (
            <div className="rfm-share-password-box">
              <div className="rfm-share-input-group">
                <label className="rfm-share-input-label">
                  Password Protected
                </label>
                <input
                  type="text"
                  ...
                  onKeyDown={(e) =>
                    e.key === "Enter" && handleVerifyPassword(e as any)
                  }
                  autoFocus
                />
              </div>
                  ...
                  <div className="flex flex-col items-center gap-4 mt-6">
                    ...
                    {shareInfo.permission === "download" && (
                      <button
                        ...
                        onClick={() =>
                          handleDownload(viewingItem.id, viewingItem.filename)
                        }
                      >
                    ...
                    folderContents.map((item) => (
                      ...
                      >
                        <div className="rfm-share-file-info">
                          ...
                          <div className="flex flex-col min-w-0">
                            <span className="rfm-share-file-name">
                              {item.filename}
                            </span>
