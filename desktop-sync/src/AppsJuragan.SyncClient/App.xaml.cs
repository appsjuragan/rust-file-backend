using AppsJuragan.SyncClient.Services;
using AppsJuragan.SyncClient.ViewModels;
using AppsJuragan.SyncClient.Views;
using AppsJuragan.ShellExtension;
...
namespace AppsJuragan.SyncClient;
        ...
        if (auth.IsAuthenticated)
        {
            _ = Task.Run(async () =>
            {
                try
                {
                    ...
                    if (settings.Current.LocalSyncFolder.EndsWith("AppsJuragan") || settings.Current.LocalSyncFolder.EndsWith("User"))
                    {
