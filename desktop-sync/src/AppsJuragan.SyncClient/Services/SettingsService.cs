...
/// <summary>Persisted user settings stored in %LocalAppData%\AppsJuragan\SyncClient\settings.json</summary>
public class AppSettings
{
    ...
    public string LocalSyncFolder { get; set; } = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "AppsJuragan");
...
public class SettingsService
{
    private static readonly string SettingsPath = Path.Combine(
        ...
        "AppsJuragan", "SyncClient", "settings.json");
