...
public static class ShellOverlayRegistrar
{
    private static readonly string[] OverlayNames = {
        "   AppsJuragan_1_Synced", // Spaces force higher priority in Explorer's alphabetical limit (max 15 overlays system-wide)
        "   AppsJuragan_2_Shared",
        "   AppsJuragan_3_Favorite"
    };
